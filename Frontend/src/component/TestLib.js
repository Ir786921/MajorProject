    ...
    {/* <div className="container"> */}
        <div className="row">
           <div className=' tw-flex tw-justify-center tw-items-center tw-mb-5'>
            <input type="search" name="" className=' tw-w-3/4 tw-p-2'value={searchtext} onChange={(e)=>{
              setSearchtext(e.target.value)
            }} placeholder='what you looking for?' id="" onKeyUp={SearchFunc} />
           </div>
            <div className="col-md-2 border border-success tw-flex sm:tw-justify-end tw-justify-center">
                <SideBar/>
            </div>
            <div className="col-md-10 border border-danger tw-p-3 tw-items-center">
